...
const RowProblem = (props) => {
    ...
    return (
        <div><div class="job-box d-md-flex align-items-center justify-content-between mb-3">
            ...
            <NavLink to={`/user/blog/${props.problem.title}/${props.problem._id}`} target="_blank" style={{textDecoration:"none"}} ><button style={{ textDecoration: "none" }} class="button-css">Read <FontAwesomeIcon color='white' icon={faArrowUpRightFromSquare} /></button></NavLink>
            </div>
        </div></div>
    )
}

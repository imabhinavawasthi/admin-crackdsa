                  ...
                  <div class="formbg mt-4">
                    <div class="formbg-inner padding-horizontal--48">
                      ...
                      <form id="addproblem-form">
                        <h2 className='heading-addproblem mb-5'>Add New Article</h2>
                        <div style={{ width: "100%" }} class="career-form row p-0 mb-2">
                          <div class="col-md-12 col-lg-12 my-2">
                            <div class="input-group position-relative">
                              <input onChange={(e) => {setError({des:error.des,name:false,link:error.link}); setProblemName(e.target.value) }} type="text" class="form-control" placeholder="Enter Article Name" id="keywords" />
                        ...
                        {error.name&&<p style={{color:"red"}}>* Enter Article Name</p>}
                        <div style={{ width: "100%" }} class="career-form row p-0 mb-2">
                          <div class="col-md-12 col-lg-12 my-2">
                            <div class="input-group position-relative">
                              <input onChange={(e) => { setError({des:error.des,name:error.name,link:false}); setProblemLink(e.target.value); }} type="text" class="form-control" placeholder="Enter Resource Link" id="keywords" />
                            </div>
                          </div>
                        </div>
                        {error.link&&<p style={{color:"red"}}>* Enter Resource Link</p>}
                        <div style={{ width: "100%" }} class="career-form row p-0 mb-2">
                        ...
                        {error.des&&<p style={{color:"red"}}>* Enter Article Body</p>}
                        ...
                        {sloading?<div className='mt-3'><Loading/></div>:<button onClick={(e) => { submitform(e) }} className='mt-5 button-css' type="submit" for="addproblem-form">Publish Article</button>}
                      </form>
                    </div>
                  </div>

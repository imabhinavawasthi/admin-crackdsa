                        ...
                        <div class="career-search mb-60">
                                    ...
                                    <div style={{ width: "100%" }} class="row p-4">
                                        <div class="col-md-6 col-lg-3 my-2">
                                            <div class="input-group position-relative">
                                                <input onChange={(e) => { setNameSearch(e.target.value); }} type="text" class="form-control" placeholder="Enter Article Name" id="keywords" />
                                            </div>
                                        </div>
                            ...
                            <div class="filter-result ">
                                ...
                                {problemsFilter?.length == 0 && problems?.length == 0 && <div className='error-page-css'>
                                    <div class="text div-error-css">
                                        <h1 style={{ color: "#F66947" }} className='h1-error-css'>OOP!</h1>
                                        <h2>You haven't added any article yet :(</h2>
                                        <h3>Add article <NavLink className="a-error-css" to="/user/addproblem" >HERE</NavLink></h3>
                                    </div>
                                </div>}
